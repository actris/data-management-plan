...
3. [Data Management at the ACTRIS data centre](#3-Data-Management-at-the-ACTRIS-data-centre)
	3.1. [Findable: Making data findable, including provisions for metadata [FAIR data]](#findable)
	3.2. [Accessible: Making data openly accessible [FAIR data]](#accessible)
	3.3. [Interoperable: Making data interoperable [FAIR data]](#interoperable)
	3.4. [Reuseable: Increase data re-use (through clarifying licenses) [FAIR data]](#reusable)
4. [Allocation of resources](#4-Allocation-of-resources)
5. [Data security](#5-Data-security)
6. [Ethical aspects](#6-Ethical-aspects)
7. [Other](#7-Other)
8. [Appendix](#8-Appendix)
	8.1. [Appendix 1: List of ACTRIS variables and recommended methodology](#Appendix-1-List-of-ACTRIS-variables-and-recommended-methodology)
	8.2. [Appendix 2: List of ACTRIS level 3 data products](#Appendix-2-List-of-ACTRIS-level-3-data-products)
	8.3. [Appendix 3: ACTRIS In situ data centre unit (In-Situ) data life cycle](#Appendix-3-ACTRIS-In-situ-data-centre-unit-In-Situ-data-life-cycle)
	8.4. [Appendix 4: ACTRIS Aerosol remote sensing data centre unit (ARES) data life cycle and workflow diagram](#Appendix-4-ACTRIS-Aerosol-remote-sensing-data-centre-unit-data-life-cycle-and-workflow-diagram)
	8.5. [Appendix 5: ACTRIS Cloud remote sensing data centre unit (CLU) data life cycle and workflow diagram](#Appendix-5-ACTRIS-Cloud-remote-sensing-data-centre-unit-data-life-cycle-and-workflow-diagram)
	8.6. [Appendix 6: ACTRIS trace gases remote sensing data centre unit (GRES) data life cycle and workflow diagram](#Appendix-6-ACTRIS-trace-gases-remote-sensing-data-centre-unit-data-life-cycle-and-workflow-diagram)
	8.7. [Appendix 7: ACTRIS Atmospheric simulation chamber data centre unit (ASC) data life cycle and workflow diagram](#Appendix-7-ACTRIS-Atmospheric-simulation-chamber-data-centre-unit-data-life-cycle-and-workflow-diagram)
	8.8. [Appendix 8: Data lifecycle and workflow for ACCESS Data Centre Unit](#Appendix-8-Data-lifecycle-and-workflow-for-ACCESS-Data-Centre-Unit)
