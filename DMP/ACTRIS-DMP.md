...
* [ACTRIS Aerosol remote sensing data centre unit (ARES)](https://data.actris-ares.eu/)
...
|         ARES             |          JSON via REST API, HTTP via Apache Server|  https://api.actris-ares.eu/api/services/ , https://api.actris-ares.eu/api/swagger-ui/# (API documentation), https://data.actris-ares.eu/           |       ISO 19115-2 , ECMA262-3, CF-1.11, NCML, RFC2616               |
...
|         ARES                     |          netCDF              |                 https://data.actris-ares.eu/                                                                                                                          |              HTTP               | No                                   |
...
| ARES                     | https://api.actris-ares.eu/api/services/restapi?_wadl                                                        |https://api.actris-ares.eu/api/services/restapi?_wadl                                                                                               |
